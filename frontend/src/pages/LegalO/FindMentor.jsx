        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8">
              Connect with experienced legal professionals and accelerate your career growth
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Find mentors specializing in various areas of law and practice
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">Business law, mergers, acquisitions</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Criminal Law</h3>
              <p className="text-gray-600 text-sm">Defense, prosecution, criminal procedure</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Tax Law</h3>
              <p className="text-gray-600 text-sm">Tax planning, compliance, disputes</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">Patents, trademarks, copyrights</p>
            </div>
          </div>
        </div>
      </section>
